        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' data: https://flagcdn.com https://www.flaggle.fun https://www.monumentle.fun https://www.daily-challenge.fun https://www.numlink.fun https://www.classic-snake.com https://browse-ai.tools https://www.stop-watch.online https://www.flip-a-coin.online https://www.wheel-spinner.online https://commons.wikimedia.org https://cdn.jsdelivr.net",
              "font-src 'self' https://fonts.gstatic.com",
              "connect-src 'self' https://www.google-analytics.com https://www.googletagmanager.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://*.adtrafficquality.google https://ipapi.co https://cdn.jsdelivr.net",
              "frame-src 'none'",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
