    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-sky-100 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Regional flag pages */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-center text-gray-900 dark:text-white mb-3">Explore other regional flag pages</h2>
            <p className="text-center text-gray-700 dark:text-gray-300 mb-5">Browse continent pages with larger flags, quick facts, and links to each country’s history and printable downloads.</p>
