  ...
  return (
    <html lang="en" suppressHydrationWarning={true}>
      <head>
        ...
        {/* Favicon */}
        {/* Prefer /icon.png generated by app/icon.tsx; keep fallbacks */}
        {/* Favicon fallbacks: use known-good /logo.png first, plus ICO/PNGs */}
        <link rel="icon" href="/logo.png?v=4" />
        <link rel="shortcut icon" href="/logo.png?v=4" />
        ...
        {/* Removed global Monumentle FAQ JSON-LD to avoid duplicate FAQ on specific pages */}
