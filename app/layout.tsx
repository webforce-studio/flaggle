...
export const metadata: Metadata = {
  title: "Flaggle - Daily Flag Guessing Game | Test Your World Knowledge",
  description:
    "Play Flaggle, the daily flag guessing game! Identify world countries from progressively revealed flag images. Features 150+ countries from all continents. A free daily puzzle game for geography enthusiasts and flag lovers. Perfect for students, educators, and travel enthusiasts.",
  keywords: [
    "flaggle",
    "flag wordle", 
    "daily flag game",
    ...
    "world flag facts",
    "today's flaggle answer",
    "flaggle hints",
    "world flaggle solution",
    "geography challenges",
    "country learning games"
  ].join(", "),
  authors: [{ name: "Flaggle Team" }],
  creator: "Flaggle",
  publisher: "Flaggle",
  formatDetection: {
    email: false,
  ...
  openGraph: {
    title: "Flaggle - Daily Flag Guessing Game | 150+ World Countries",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Flaggle - Daily Flag Guessing Game with World Countries",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "Flaggle - Daily Flag Guessing Game",
